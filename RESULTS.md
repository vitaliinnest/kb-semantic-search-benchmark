...
|-------|-----------|--------|---------|------|---------|
| E5-base (Microsoft multilingual-e5-base) | 0.7800 | 0.6340 | 0.6121 | 0.1360 | 61.1 |
| Nomic (nomic-embed-text-v1.5) | 0.4725 | 0.4122 | 0.3765 | 0.0750 | 112.2 |
| BGE-M3 (BAAI/bge-m3) | 0.8150 | 0.6993 | 0.6722 | 0.1430 | 200.8 |
| Qwen3-Embedding-0.6B | 0.7792 | 0.6640 | 0.6325 | 0.1360 | 397.4 |
...
| Model | Recall@10 | MRR@10 | nDCG@10 | P@10 | ms/query |
|-------|-----------|--------|---------|------|---------|
| E5-base (Microsoft multilingual-e5-base) | 0.3500 | 0.3145 | 0.2567 | 0.0990 | 59.8 |
| Nomic (nomic-embed-text-v1.5) | 0.1250 | 0.1384 | 0.0951 | 0.0370 | 120.1 |
| BGE-M3 (BAAI/bge-m3) | 0.3750 | 0.3831 | 0.3065 | 0.1060 | 215.1 |
| Qwen3-Embedding-0.6B | 0.3750 | 0.3999 | 0.3199 | 0.1070 | 406.4 |
| text-embedding-3-large (OpenAI) | — | — | — | — | — (API key not available) |
...
| Model | Recall@10 | MRR@10 | nDCG@10 | P@10 | ms/query |
|-------|-----------|--------|---------|------|---------|
| E5-base (Microsoft multilingual-e5-base) | 0.4583 | 0.4888 | 0.3909 | 0.1140 | 71.8 |
| Nomic (nomic-embed-text-v1.5) | 0.1917 | 0.2110 | 0.1668 | 0.0510 | 144.6 |
| BGE-M3 (BAAI/bge-m3) | 0.5450 | 0.5054 | 0.4339 | 0.1400 | 236.8 |
| Qwen3-Embedding-0.6B | 0.4483 | 0.4184 | 0.3629 | 0.1150 | 418.9 |
| text-embedding-3-large (OpenAI) | — | — | — | — | — (API key not available) |

...
Теоретичну частину дослідження подано в роботі [1], де обґрунтовано проблему «лексичного розриву» та виконано порівняльний аналіз моделей fastText, BERT, SBERT і OpenAI Embeddings за їх архітектурними особливостями та придатністю до задач семантичного пошуку. У цій роботі акцент зроблено на практичній реалізації семантичного пошуку для корпоративної бази знань із фокусом на фактичній пошуковій видачі. Застосунок об’єднує підготовку даних, чанкінг, побудову векторних індексів і бенчмарк-оцінювання в одному відтворюваному контурі, що дає змогу швидко перевіряти вплив змін моделі або параметрів індексації на кінцеву якість видачі.

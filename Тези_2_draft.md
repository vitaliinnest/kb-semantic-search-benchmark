...
У роботі подано прикладну реалізацію семантичного пошуку для корпоративної бази знань із фокусом на фактичній пошуковій видачі. Застосунок об’єднує підготовку даних, чанкінг, побудову векторних індексів і бенчмарк-оцінювання в одному відтворюваному контурі. Рішення реалізовано на Python: веб-частину виконано на Flask/Jinja2, векторну індексацію — на FAISS, а моделі ембедингів підключено через sentence-transformers, scikit-learn (TF-IDF) і gensim (word2vec/fastText). Така конфігурація дає змогу швидко перевіряти вплив змін моделі або параметрів індексації на кінцеву якість видачі.

...
> Той самий запит про churn — кількісна картина. Зверху — порівняння всіх моделей. **Тільки BGE-M3 має nDCG 1.0** — релевантний документ на першій позиції. Qwen3 — 0.500, E5-base — 0.431, BM25 — 0.356, nomic — 0.315. При цьому **Recall у всіх дорівнює 1.0** — релевантний фрагмент знайдено в топ-10 кожною моделлю, відрізняється лише **ранжування**: BGE ставить релевантне першим, BM25 — аж на шостій позиції. Нижче — топ-K результатів з підсвічуванням релевантних фрагментів. Інструмент для діагностики — коли треба зрозуміти, чому модель промахується на конкретному запиті.
